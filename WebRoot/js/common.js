...
var imgEdit="/dangan/img/edit.gif";
var imgDel="/dangan/img/del.png";
var imgSave="/dangan/img/save.png";
var clpath=compath+"cailiaoFile/";
var B;
var exportObj=null;
...
function selectType(tbidw){	
 	$("#"+tbidw+" table tr:not(:first)").bind("click",function(){
 		backBgcol(tbidw);
    	$(this).find("td").css("color","#0033ff").css("font-weight","700").css("background-image","url('/baijia/images/menuson.gif')");
 	});    	
  }
//获得选中行的ZID
...
var z_by=["0"];var objs;var en_name,tit_num;
...
function madeTableTrWidth(table,colnum){
	$(table).find("tr").each(function(i){
		...
		var tx=td.text();
		if(i==0){
			td.html(tx+"<font color=red>(双击查看详情)</font>");
		}
		if(i>0){
