...
public interface UsualStrMethod {
	...
	public List<String[]> getXlsValue(int lieNum,int line,File file,int num);
	//取导航
	public String getDaoHang(String menuid);	
	public String point="<img src='/dangan/toolImage/log_04.gif' title='点击这里'/>";           //指向箭头
	public String imgEdit="/dangan/img/edit.gif";
	public String imgDel="/dangan/img/del.png";
	public String imgSave="/dangan/img/save.png";
	//===导出EXCEL
